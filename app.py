...
date_guard = st.text_input("Which date is today (yyyy-mm-dd)?", placeholder="Type today's date to enable Run button and ask questions")

# --- Run button only active if entered ---
can_run = date_guard == st.secrets["today_date"]
